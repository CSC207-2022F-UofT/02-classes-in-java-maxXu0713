...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes two Strings as an argument and adds them together.
     *
     * @param first_half the first half of the name of this Silly instance.
     * @param second_half the second half of the name of this Silly instance.
     */
